...
import com.lxy.javabasedemo.base.*;
...
public class BaseController {
    ...
    public
    ResponseEntity BaseArgumentExceptionHandler(ArgumentException e) {
        logger.warn(e.getLocalizedMessage());
        return this.getFailResult(e.getErrCode(), e.getMessage());
    }
    ...
    public
    ResponseEntity BaseRuntimeExceptionHandler(BaseRuntimeException e) {
        logger.warn(e.getLocalizedMessage());
        return this.getFailResult(e.getErrCode(), e.getMessage());
    }
    ...
    public
    ResponseEntity runtimeExceptionHandler(RuntimeException e, HttpServletResponse response) {
     ...
     * @return
     */
    protected <T> ListResponse<T> getListResponse(List<T> dataList) {
     ...
     * @return
     */
    protected <T> PageResponse<T> getPageResponse(BaseCondition condition, long totalCount, List<T> dataList) {
        return new PageResponse<>(condition.getPageNum(), condition.getPageSize(), totalCount, dataList);
    }
     ...
     * @return
     */
    protected <T> PageResponse<T> getPageResponse(BaseQueryForm form, long totalCount, List<T> dataList) {
        return new PageResponse<>(form.getPageNum(), form.getPageSize(), totalCount, dataList);
    }
     ...
     * @return
     */
    protected <T> PageResponse<T> getPageResponse(int pageNum, int pageSize, long totalCount, List<T> dataList) {
